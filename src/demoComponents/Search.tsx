  ...
  return (
    <div className="min-[1000px]:pl-[80px] mm:pl-[50px] pl-[35px]">
      ...
      <div className="md:flex block  justify-between items-center min-[1000px]:pr-[80px] mm:pr-[50px] pr-[35px]">
        ...
        <button className="bg-[#E6F3F3] h-[46px] w-[121px] md:mt-0 mt-4 rounded-xl flex items-center justify-center gap-2">
          <Image
            src="/filter.png"
            width={21.5}
            height={17}
      ...
      <div className="hideScroll grid grid-flow-col overflow-hidden overflow-x-scroll py-[24px]  pr-[80px] gap-4">
        {card
          .filter((card) =>
            card.name
              .toLowerCase()
